...
export const NavbarComponent = (props: NavbarComponentProps): JSX.Element => {
  ...
  return (
    <Navbar
      ...
      rounded={true}
    >
      <Navbar.Brand href="/" className="items-start gap-3 pr-3 lg:pr-0">
        ...
        <div className="min-w-0">
          ...
          <span className="block self-center text-base font-bold tracking-[0.02em] text-slate-900 sm:text-lg md:text-[1.1rem] lg:text-xl">
            浜松市イベントカレンダー
          </span>
        </div>
      </Navbar.Brand>
      <div className="mt-3 flex w-full items-center gap-2 lg:mt-0 lg:w-auto lg:justify-end lg:order-2">
        <div className="w-full rounded-[22px] border border-slate-200 bg-white/90 px-2 py-2 shadow-sm lg:w-auto">
          ...
          <div className="mt-1 flex items-center gap-2">
            ...
            <div className="min-w-0 flex-1 lg:flex-none">
              <Dropdown
                ...
                inline={true}
                theme={{ inlineWrapper: "inline-flex w-full min-w-0 items-center justify-center rounded-full border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-800 shadow-sm transition hover:border-sky-300 hover:text-sky-700 lg:min-w-[136px]" }}
                dismissOnClick={true}
              >
